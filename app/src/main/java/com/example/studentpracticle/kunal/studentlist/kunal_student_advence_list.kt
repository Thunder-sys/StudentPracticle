...
class kunal_student_advence_list : AppCompatActivity() {
    ...
    private fun getdatalist(): ArrayList<student_id_modelclass> {
        ...
        var student1 =
            student_id_modelclass("Akshya Kumar", "Hari Om Bhatia", "1", "A", R.drawable.akshay)
        var student2 = student_id_modelclass("Ajay", "Veeru Devgan", "2", "A", R.drawable.ajay)
        var student3 =
            student_id_modelclass("Divya", "Jitendra Deshmukh", "3", "B", R.drawable.divya)
        var student4 =
            student_id_modelclass("Haritik", "Rakesh Roshan", "4", "A", R.drawable.hritki)
        var student5 = student_id_modelclass("Kirati", "Rahul Sanon", "5", "B", R.drawable.kriti)
        var student6 =
            student_id_modelclass("Rao", " Late Shri G.Venkateswara Rao", "6", "A", R.drawable.rao)
        var student7 =
            student_id_modelclass("Siddharth", "Sunil Malhotra", "7", "A", R.drawable.siddharth)
